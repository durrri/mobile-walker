...
import { createPoiBeaconDefinition, createPoiStructure } from "./poiStructures";
...
export type PoiBeaconFixtureKind = "fire" | "lantern";
export type PoiBeaconProfile = "homestead" | "waterside" | "cabin" | "regional-watchtower";
export interface PoiBeaconFixtureDefinition {
  readonly id: PoiBeaconFixtureKind;
  readonly kind: PoiBeaconFixtureKind;
  readonly anchor: Readonly<{ x: number; y: number; z: number }>;
}
export interface PoiBeaconDefinition {
  readonly profile: PoiBeaconProfile;
  readonly fixtures: readonly PoiBeaconFixtureDefinition[];
}
export interface GeneratedPoi {
  ...
  readonly beacon?:PoiBeaconDefinition;
